...
for (i in 2:10) {
  set.seed(i)
  p_values_2[i - 1, 1] <- boot.time.inference.log.var(Ropt_ls_0[, c(1, i)], b = block, M = 500)$p.Value
  p_values_2[i - 1, 2] <- boot.time.inference.log.var(Ropt_ls_1[, c(1, i)], b = block, M = 500)$p.Value
  p_values_2[i - 1, 3] <- boot.time.inference.log.var(Ropt_ls_2[, c(1, i)], b = block, M = 500)$p.Value
  p_values_2[i - 1, 4] <- boot.time.inference.log.var(Ropt_ls_3[, c(1, i)], b = block, M = 500)$p.Value
  p_values_2[i - 1, 5] <- boot.time.inference.log.var(Ropt_ls_4[, c(1, i)], b = block, M = 500)$p.Value
}
...
for (i in 2:10) {
  set.seed(i)
  p_values_5[i - 1, 1] <- boot.time.inference.log.var(Ropt_ls_0[, c(1, i)], b = block, M = 500)$p.Value
  p_values_5[i - 1, 2] <- boot.time.inference.log.var(Ropt_ls_1[, c(1, i)], b = block, M = 500)$p.Value
  p_values_5[i - 1, 3] <- boot.time.inference.log.var(Ropt_ls_2[, c(1, i)], b = block, M = 500)$p.Value
  p_values_5[i - 1, 4] <- boot.time.inference.log.var(Ropt_ls_3[, c(1, i)], b = block, M = 500)$p.Value
  p_values_5[i - 1, 5] <- boot.time.inference.log.var(Ropt_ls_4[, c(1, i)], b = block, M = 500)$p.Value
}
...
for (i in 2:10) {
  set.seed(i)
  p_values_7[i - 1, 1] <- boot.time.inference.log.var(Ropt_ls_0[, c(1, i)], b = block, M = 500)$p.Value
  p_values_7[i - 1, 2] <- boot.time.inference.log.var(Ropt_ls_1[, c(1, i)], b = block, M = 500)$p.Value
  p_values_7[i - 1, 3] <- boot.time.inference.log.var(Ropt_ls_2[, c(1, i)], b = block, M = 500)$p.Value
  p_values_7[i - 1, 4] <- boot.time.inference.log.var(Ropt_ls_3[, c(1, i)], b = block, M = 500)$p.Value
  p_values_7[i - 1, 5] <- boot.time.inference.log.var(Ropt_ls_4[, c(1, i)], b = block, M = 500)$p.Value
}
...
for (i in 2:10) {
  set.seed(i)
  p_values_05[i - 1, 1] <- boot.time.inference.log.var(Ropt_ls_0[, c(1, i)], b = block, M = 500)$p.Value
  p_values_05[i - 1, 2] <- boot.time.inference.log.var(Ropt_ls_1[, c(1, i)], b = block, M = 500)$p.Value
  p_values_05[i - 1, 3] <- boot.time.inference.log.var(Ropt_ls_2[, c(1, i)], b = block, M = 500)$p.Value
  p_values_05[i - 1, 4] <- boot.time.inference.log.var(Ropt_ls_3[, c(1, i)], b = block, M = 500)$p.Value
  p_values_05[i - 1, 5] <- boot.time.inference.log.var(Ropt_ls_4[, c(1, i)], b = block, M = 500)$p.Value
}
...
for (i in 2:10) {
  set.seed(i)
  p_values_1[i - 1, 1] <- boot.time.inference.log.var(Ropt_ls_0[, c(1, i)], b = block, M = 500)$p.Value
  p_values_1[i - 1, 2] <- boot.time.inference.log.var(Ropt_ls_1[, c(1, i)], b = block, M = 500)$p.Value
  p_values_1[i - 1, 3] <- boot.time.inference.log.var(Ropt_ls_2[, c(1, i)], b = block, M = 500)$p.Value
  p_values_1[i - 1, 4] <- boot.time.inference.log.var(Ropt_ls_3[, c(1, i)], b = block, M = 500)$p.Value
  p_values_1[i - 1, 5] <- boot.time.inference.log.var(Ropt_ls_4[, c(1, i)], b = block, M = 500)$p.Value
}
